...
},{"./emptyFunction":16}],24:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/invariant":14,"fbjs/lib/warning":15,"./lib/ReactPropTypesSecret":24}],7:[function(require,module,exports) {
...
},{"object-assign":12,"fbjs/lib/invariant":14,"fbjs/lib/emptyObject":13,"fbjs/lib/warning":15,"fbjs/lib/emptyFunction":16,"prop-types/checkPropTypes":17}],5:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react.development.js":7}],18:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./isNode":29}],21:[function(require,module,exports) {
'use strict';
...
},{"./isTextNode":25}],26:[function(require,module,exports) {
'use strict';
...
},{"./camelize":27}],8:[function(require,module,exports) {
/** @license React v16.3.2
...
},{"fbjs/lib/invariant":14,"react":5,"fbjs/lib/warning":15,"fbjs/lib/ExecutionEnvironment":18,"object-assign":12,"fbjs/lib/emptyFunction":16,"prop-types/checkPropTypes":17,"fbjs/lib/getActiveElement":19,"fbjs/lib/shallowEqual":20,"fbjs/lib/containsNode":21,"fbjs/lib/emptyObject":13,"fbjs/lib/hyphenateStyleName":22,"fbjs/lib/camelizeStyleName":23}],6:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react-dom.development.js":8}],9:[function(require,module,exports) {
'use strict';
...
var Profile = function (_React$Component) {
  ...
  _createClass(Profile, [{
    ...
    value: function render() {
      ...
      if (data.notFound === 'Not Found') return _react2.default.createElement(
        "div",
        { className: "notfound" },
        ...
        _react2.default.createElement(
          "div",
          { className: "github--profile__info" },
          _react2.default.createElement(
            "a",
            { href: data.homeUrl, target: "_blank", title: data.name || data.username },
            _react2.default.createElement("img", { src: data.avatar, alt: data.username })
          ),
          _react2.default.createElement(
            "h2",
            null,
            _react2.default.createElement(
              "a",
              { href: data.homeUrl, title: data.username, target: "_blank" },
        ...
        _react2.default.createElement(
          "div",
          { className: "github--profile__state" },
          _react2.default.createElement(
            "ul",
            null,
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                "a",
                { href: followers, target: "_blank", title: "Number Of Followers" },
                _react2.default.createElement(
                  "i",
                  null,
                  data.followers
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                "a",
                { href: repositories, target: "_blank", title: "Number Of Repositoriy" },
                _react2.default.createElement(
                  "i",
                  null,
                  data.repos
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                "a",
                { href: following, target: "_blank", title: "Number Of Following" },
                _react2.default.createElement(
                  "i",
                  null,
                  data.following
...
},{"react":5,"react-dom":6}],11:[function(require,module,exports) {
"use strict";
...
var SearchProfile = function (_React$Component) {
  _inherits(SearchProfile, _React$Component);

  function SearchProfile() {
    _classCallCheck(this, SearchProfile);

    return _possibleConstructorReturn(this, (SearchProfile.__proto__ || Object.getPrototypeOf(SearchProfile)).apply(this, arguments));
  }

  _createClass(SearchProfile, [{
    key: "render",
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "label",
            null,
            _react2.default.createElement("input", { type: "search", ref: "username", placeholder: "Type Username + Enter" })
          )
        )
      );
    }
    ...
    value: function handleForm(e) {
      e.preventDefault();
      var usernames = this.refs.username.value;
...
},{"react":5,"react-dom":6}],4:[function(require,module,exports) {
"use strict";
...
var _SearchProfile = require("./SearchProfile");

var _SearchProfile2 = _interopRequireDefault(_SearchProfile);
...
var UserInfo = function (_React$Component) {
  ...
  _createClass(UserInfo, [{
    ...
    value: function fetchProfile(username) {
      ...
      var url = _api2.default + "/" + username;
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "section",
          { id: "card" },
          _react2.default.createElement(_SearchProfile2.default, { fetchProfile: this.fetchProfile.bind(this) }),
          _react2.default.createElement(_Profile2.default, { data: this.state })
        )
      );
    }
  }]);
...
},{"react":5,"react-dom":6,"../utils/api":9,"./Profile":10,"./SearchProfile":11}],2:[function(require,module,exports) {
"use strict";
...
_reactDom2.default.render(view, mountNode);
},{"react":5,"react-dom":6,"./components/UserInfo":4}],31:[function(require,module,exports) {
...
//# sourceMappingURL=/src.811349eb.map